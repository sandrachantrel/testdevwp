...
(function ($, window, document, undefined) {
    ...
    CSF.helper = {
        ...
        name_nested_replace: function ($selector, field_id) {
            ...
            var regex = new RegExp(
                CSF.helper.preg_quote(field_id + '[\\d+]'),
                'g'
            );
    ...
    $.fn.csf_nav_options = function () {
        return this.each(function () {
            ...
            $window
                .on('hashchange csf.hashchange', function () {
                    ...
                    if ($link.length) {
                        $link
                            .closest('.csf-tab-item')
                            .addClass('csf-tab-expanded')
                            .siblings()
                            .removeClass('csf-tab-expanded');
        ...
        if (this.length) {
            $(document).on(
                ...
                function () {
                    ...
                    $('.csf-page-templates')
                        .removeClass('csf-metabox-show')
                        .addClass('csf-metabox-hide');
                    $(
                        '.csf-page-' +
                            maybe_value
                                .toLowerCase()
                        ...
                        .removeClass('csf-metabox-hide')
                        .addClass('csf-metabox-show');
                }
            );
        }
    };
            ...
            var interval = setInterval(function () {
                if ($this.is(':visible')) {
                    ...
                    if (
                        ...
                        CSF.vars.code_themes.indexOf(data_editor.theme) === -1
                    ) {
                        var $cssLink = $('<link>');
                    ...
                    CodeMirror.modeURL =
                        data_editor.cdnURL + '/mode/%N/%N.min.js';
        ...
        return this.each(function () {
            ...
            $this.on('click', '.csf-button, .csf-edit-gallery', function (e) {
                ...
                wp_media_frame.on('update', function (selection) {
                    ...
                    var selectedIds = selection.models.map(function (
                        attachment
                    ) {
    ...
    $.fn.csf_field_group = function () {
        return this.each(function () {
            ...
            var update_title_numbers = function ($selector) {
                $selector
                    .find('.csf-cloneable-title-number')
                    .each(function (index) {
                        $(this).html(
                            $(this).closest('.csf-cloneable-item').index() +
                                1 +
                                '.'
                        );
                    });
            ...
            $wrapper.sortable({
                ...
                start: function (event, ui) {
                    ...
                    ui.item
                        .children('.csf-cloneable-content')
                        .data('retry', true);
                },
                update: function (event, ui) {
                    CSF.helper.name_nested_replace(
                        $wrapper.children('.csf-cloneable-item'),
                        field_id
                    );
            ...
            $wrapper
                ...
                .children('.csf-cloneable-helper')
                .on('click', '.csf-cloneable-clone', event_clone);
            $group
            ...
            $wrapper
                .children('.csf-cloneable-item')
                .children('.csf-cloneable-helper')
                .on('click', '.csf-cloneable-remove', event_remove);
            $group
                .children('.csf-cloneable-hidden')
                .children('.csf-cloneable-helper')
                .on('click', '.csf-cloneable-remove', event_remove);
                    ...
                    window.wp.ajax
                        ...
                        .done(function (response) {
                            ...
                            $load.on('click', 'i', function (e) {
                                ...
                                CSF.vars.$icon_target
                                    .find('.csf-icon-preview i')
                                    .removeAttr('class')
                                    .addClass(icon);
                                CSF.vars.$icon_target
        ...
        return this.each(function () {
            ...
            $search_input.autocomplete({
                ...
                create: function (event, ui) {
                    $(this)
                        .autocomplete('widget')
                        .addClass('csf-map-ui-autocomplate');
                },
            });
    ...
    $.fn.csf_field_link = function () {
        return this.each(function () {
            ...
            $edit.on('click', function (e) {
                ...
                $('#wp-link-target').prop(
                    'checked',
                    $this.find('.csf--target').val() === '_blank'
                );
            });
        ...
        return this.each(function () {
            var $this = $(this),
                ...
                $library =
                    ...
                    '',
                $auto_attributes = $this.hasClass('csf-assign-field-background')
                    ? $this
                          .closest('.csf-field-background')
                          .find('.csf--auto-attributes')
                    : false,
                wp_media_frame;
            ...
            $upload_button.on('click', function (e) {
                ...
                wp_media_frame.on('select', function () {
                    ...
                    var attributes = wp_media_frame
                        ...
                        .first().attributes;
                    var preview_size =
                        $upload_button.data('preview-size') || 'thumbnail';
    ...
    $.fn.csf_field_repeater = function () {
        return this.each(function () {
            ...
            $wrapper.sortable({
                ...
                update: function (event, ui) {
                    CSF.helper.name_nested_replace(
                        $wrapper.children('.csf-repeater-item'),
                        field_id
                    );
                    $wrapper.csf_customizer_refresh();
            ...
            $wrapper
                .children('.csf-repeater-item')
                .children('.csf-repeater-helper')
                .on('click', '.csf-repeater-clone', event_clone);
            $repeater
            ...
            $wrapper
                .children('.csf-repeater-item')
                .children('.csf-repeater-helper')
                .on('click', '.csf-repeater-remove', event_remove);
            $repeater
                .children('.csf-repeater-hidden')
                .children('.csf-repeater-helper')
                .on('click', '.csf-repeater-remove', event_remove);
            ...
            $enabled.sortable({
                ...
                update: function (event, ui) {
                    ...
                    if (ui.item.parent().hasClass('csf-enabled')) {
                        $el.attr(
                            'name',
                            $el.attr('name').replace('disabled', 'enabled')
                        );
                    } else {
                        $el.attr(
                            'name',
                            $el.attr('name').replace('enabled', 'disabled')
                        );
                    }
        ...
        return this.each(function () {
            ...
            base.append_select_options = function (
                ...
                $.each(options, function (key, value) {
                    ...
                    if (is_multi) {
                        selected =
                            condition && condition.indexOf(value) !== -1
                                ? ' selected'
                                : '';
                    } else {
                        selected =
                            condition && condition === value ? ' selected' : '';
                    }
            ...
            base.init = function () {
                ...
                if ($font_style_block.length) {
                    ...
                    if ($extra_font_style_block.length) {
                        var $extra_font_style_select =
                            $this.find('.csf--extra-styles');
                        var first_extra_style_value =
                            $extra_font_style_select.val();
                    }
                }
                ...
                if ($subset_block.length) {
                    ...
                    var subset_multi_select =
                        $subset_select.data('multiple') || false;
                }
                ...
                $font_family_select
                    .on('change csf.change', function (event) {
                        ...
                        if (type && value) {
                            ...
                            if ($font_style_block.length) {
                                ...
                                var set_auto_style =
                                    styles.indexOf('normal') !== -1
                                        ? 'normal'
                                        : styles[0];
                                var set_style_value =
                                    first_style_value &&
                                    styles.indexOf(first_style_value) !== -1
                                        ? first_style_value
                                        : set_auto_style;
                                ...
                                if (
                                    ...
                                    // Show style select after appended
                                    $extra_font_style_block.removeClass(
                                        'hidden'
                                    );
                                }
                            }
                        ...
                        CSF.helper.debounce(function (event) {
                            ...
                            var font_family = $font_family_select.val(),
                                ...
                                text_align = $this
                                    ...
                                    .val(),
                                text_transform = $this
                                    .find('.csf--text-transform')
                                    .val(),
                                text_decoration = $this
                                    .find('.csf--text-decoration')
                                    .val(),
                                text_color = $this.find('.csf--color').val(),
                                word_spacing = $this
                                    .find('.csf--word-spacing')
                                    .val(),
                                letter_spacing = $this
                                    .find('.csf--letter-spacing')
                                    .val(),
                                custom_style = $this
                                    .find('.csf--custom-style')
                                    .val(),
                                type = $this.find('.csf--type').val();

                            if (type === 'google') {
                                base.load_google_font(
                                    font_family,
                                    font_weight,
                                    font_style
                                );
    ...
    $.fn.csf_field_wp_editor = function () {
        return this.each(function () {
            if (
                ...
                typeof window.tinyMCEPreInit.mceInit.csf_wp_editor ===
                    'undefined'
            ) {
                return;
            }
            ...
            if (
                ...
                window.csf_media_buttons
            ) {
                var $editor_buttons = $editor.find('.wp-media-buttons');

                if ($editor_buttons.length) {
                    $editor_buttons
                        .find('.csf-shortcode-button')
                        .data('editor-id', uid);
                } else {
    ...
    $.fn.csf_confirm = function () {
        return this.each(function () {
            $(this).on('click', function (e) {
                var confirm_text =
                    $(this).data('confirm') || window.csf_vars.i18n.confirm;
            ...
            $this.on('click', function (e) {
                if (!flooding) {
                    ...
                    if ($this.hasClass('csf-save-ajax')) {
                        ...
                        window.wp.ajax
                            .post(
                                'csf_' + $panel.data('unique') + '_ajax_save',
                                {
                            ...
                            .done(function (response) {
                                ...
                                if (Object.keys(response.errors).length) {
                                    var error_icon =
                                        '<i class="csf-label-error csf-error">!</i>';
                                    ...
                                    $.each(
                                        ...
                                        function (key, error_message) {
                                            ...
                                            $field
                                                ...
                                                .append(
                                                    '<p class="csf-error csf-error-text">' +
                                                        error_message +
                                                        '</p>'
                                                );

                                            if (
                                                !$link.find('.csf-error').length
                                            ) {
    ...
    $.fn.csf_shortcode = function () {
        ...
        base.send_to_editor = function (html, editor_id) {
            ...
            if (tinymce_editor && !tinymce_editor.isHidden()) {
                ...
                $editor
                    .val(base.insertAtChars($editor, html))
                    .trigger('change');
            }
        };
        ...
        return this.each(function () {
            ...
            $(document).on(
                'click',
                '.csf-shortcode-button[data-modal-id="' + modal_id + '"]',
                function (e) {
                    e.preventDefault();
                    ...
                    if (
                        $modal.hasClass('csf-shortcode-single') &&
                        sc_name === undefined
                    ) {
            ...
            $select.on('change', function () {
                ...
                if (sc_key) {
                    ...
                    window.wp.ajax
                        .post('csf-get-shortcode-' + modal_id, {
            ...
            $insert.on('click', function (e) {
                ...
                var shortcode = '';
                var serialize = $modal
                    .find('.csf-field:not(.csf-depend-on)')
                    .find(':input:not(.ignore)')
                    .serializeObjectCSF();

                switch (sc_view) {
                    case 'contents':
                        var contentsObj = sc_name
                            ? serialize[sc_name]
                            : serialize;
                ...
                if (gutenberg_id) {
                    var content =
                        window.csf_gutenberg_props.attributes.hasOwnProperty(
                            'shortcode'
                        )
                            ? window.csf_gutenberg_props.attributes.shortcode
                            : '';
            ...
            $modal.on('click', '.csf--repeat-button', function (e) {
                ...
                CSF.helper.name_nested_replace(
                    $modal.find('.csf--repeat-shortcode'),
                    sc_group
                );
    ...
    $.fn.csf_color = function () {
        return this.each(function () {
            var $input = $(this),
                ...
                palette_color = window.csf_vars.color_palette.length
                    ? window.csf_vars.color_palette
                    : true,
                $container;
            ...
            $input.wpColorPicker({
                ...
                create: function () {
                    ...
                    var a8cIris = $input.data('a8cIris'),
                        $transparent_wrap = $(
                            '<div class="csf--transparent-wrap">' +
                    ...
                    $transparent_slider.slider({
                        ...
                        slide: function (event, ui) {
                            ...
                            $input.wpColorPicker(
                                'color',
                                a8cIris._color.toString()
                            );
                            $transparent_text.text(
                                slide_value === 1 || slide_value === 0
                                    ? ''
                                    : slide_value
                            );
                        },
                        create: function () {
                            ...
                            $container.on(
                                ...
                                '.wp-picker-default',
                                function () {
                                    var default_color = CSF.funcs.parse_color(
            ...
            if (is_sortable) {
                ...
                $chosen_choices.sortable({
                    ...
                    update: function (e, ui) {
                        ...
                        var $prev_select = $this
                            .parent()
                            .find('.csf-hide-select');
    ...
    $.fn.csf_help = function () {
        return this.each(function () {
            ...
            $this.on({
                mouseenter: function () {
                    $tooltip = $('<div class="csf-tooltip"></div>')
                        .html($this.find('.csf-help-text').html())
                        .appendTo('body');
                    offset_left = CSF.vars.is_rtl
                        ? $this.offset().left + 24
    ...
    $.fn.csf_customizer_listen = function (options) {
        ...
        return this.each(function () {
            ...
            var $this = settings.closest
                    ? $(this).closest('.csf-customize-complex')
                    : $(this),
                $input = $this.find(':input'),
    ...
    $.fn.csf_reload_script = function (options) {
        ...
        return this.each(function () {
            ...
            if (!$this.data('inited')) {
                ...
                $this
                    .children('.csf-field-code_editor')
                    .csf_field_code_editor();
                ...
                // Field colors
                $this
                    .children('.csf-field-border')
                    .find('.csf-color')
                    .csf_color();
                $this
                    .children('.csf-field-background')
                    .find('.csf-color')
                    .csf_color();
                $this
                    .children('.csf-field-color')
                    .find('.csf-color')
                    .csf_color();
                $this
                    .children('.csf-field-color_group')
                    .find('.csf-color')
                    .csf_color();
                $this
                    .children('.csf-field-link_color')
                    .find('.csf-color')
                    .csf_color();
                $this
                    .children('.csf-field-typography')
                    .find('.csf-color')
                    .csf_color();

                // Field chosenjs
                $this
                    .children('.csf-field-select')
                    .find('.csf-chosen')
                    .csf_chosen();
